...
define_variable("global_overlay_keymap_chain_aliases", true,
    ...
    "\"M-v\" gets aliased to \"right\" if this variable is set to true, " +
    "\"M-n\" if this variable is set to false. The latter is similar to " +
    "Emacs behavior.");
...
function global_overlay_keymap_handler (window, I, true_event) {
    ...
    if (!binding)
        return false;
    if (!global_overlay_keymap_chain_aliases && true_event.aliased_by_conkeror)
        return false;
